...
msg_info "Running improved Namer installer inside CT $CTID"
if pct exec "$CTID" -- bash -lc 'bash -c "$(curl -fsSL https://raw.githubusercontent.com/Nanja-at-web/NamerAtProxmox/main/install/namer-install-community-fixed.sh)"'; then
...
echo -e "${INFO}${YW} After first start, edit this file if you want to change defaults:${CL}"
